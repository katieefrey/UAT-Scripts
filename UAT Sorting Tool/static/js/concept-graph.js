var CollapsibleTree = function(elt) {
  ...
  var vis = d3.select(elt).append("svg:svg")
      ...
      .attr("transform", "translate(20,"+h/2+")"); // bidirectional-tree
  ...
  var that = {
    ...
    updateBoth: function(source) {
      ...
      nodes.forEach(function(d) { d.y = d.depth * 50; }); //HEIGHT OF TERMS
      //nodes.forEach(function(d) { d.x = d.depth * 50; }); //WIDTH? OF TERMS
